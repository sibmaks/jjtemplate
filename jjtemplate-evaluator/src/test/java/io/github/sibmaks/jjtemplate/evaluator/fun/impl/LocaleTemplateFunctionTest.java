...
class LocaleTemplateFunctionTest {
    @InjectMocks
    private LocaleTemplateFunction function;
    ...
    void invokeTooManyArgsWithPipe() {
        ...
        assertEquals("locale: too much arguments passed", exception.getMessage());
    }
    ...
    void invokeNoArgsShouldThrow() {
        ...
        assertEquals("locale: at least 1 argument required", exception.getMessage());
    }
