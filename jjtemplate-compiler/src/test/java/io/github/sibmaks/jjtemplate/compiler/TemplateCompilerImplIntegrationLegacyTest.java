...
class TemplateCompilerImplIntegrationLegacyTest {
    ...
    private static List<Path> getCases(Path resourcesDir) {
        try (var paths = Files.list(resourcesDir)) {
            ...
            return TemplateCompilerImplIntegrationLegacyTest.<Path, Path>expand(
    ...
    public static Stream<Arguments> cases() {
        var resourcesDir = Paths.get("src", "test", "resources", "legacy-cases");
    ...
    public static Stream<Arguments> inliningCases() {
        var resourcesDir = Paths.get("src", "test", "resources", "legacy-cases", "inlining");
