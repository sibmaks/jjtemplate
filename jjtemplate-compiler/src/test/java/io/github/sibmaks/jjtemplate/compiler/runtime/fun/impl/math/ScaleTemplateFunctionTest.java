...
class ScaleTemplateFunctionTest {
    ...
    public static Stream<Arguments> scaleCases() {
        return Stream.of(
                ...
                Arguments.of(42L, 0, "HALF_DOWN", new BigDecimal("42")),
                Arguments.of(42L, 0, RoundingMode.HALF_DOWN, new BigDecimal("42")),
    ...
    @Test
    void nullNotARoundingMode() {
        var args = new ArrayList<>();
        args.add(42);
        args.add(2);
        args.add(null);
        var exception = assertThrows(TemplateEvalException.class, () -> function.invoke(args));
        assertEquals("math:scale: null cannot be converted to rounding mode", exception.getMessage());
    }
