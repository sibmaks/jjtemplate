...
class MapLengthTemplateFunctionTest {
    @InjectMocks
    private MapLengthTemplateFunction function;
    ...
    void unsupportedType() {
        ...
        assertEquals("map:len: unsupported type: " + Boolean.class, exception.getMessage());
    }
    ...
    void noArgsOnInvoke() {
        var args = List.of();
        var exception = assertThrows(TemplateEvalException.class, () -> function.invoke(args));
        assertEquals("map:len: 1 argument required", exception.getMessage());
    }
    ...
    void tooMuchArgsOnPipeInvoke() {
        ...
        assertEquals("map:len: too much arguments passed", exception.getMessage());
    }
