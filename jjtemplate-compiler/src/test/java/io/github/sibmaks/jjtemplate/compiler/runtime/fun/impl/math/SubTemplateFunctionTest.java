...
class SubTemplateFunctionTest {
    @InjectMocks
    private SubTemplateFunction function;
    ...
    @Test
    void checkName() {
        assertEquals("sub", function.getName());
    }

    @ParameterizedTest
    @MethodSource("cases")
    void subAsArgs(Number left, Number right, Number expected) {
    ...
    @ParameterizedTest
    @MethodSource("cases")
    void subAsPipe(Number left, Number right, Number expected) {
    ...
    void invalidArgsType() {
        ...
        assertEquals("math:sub: not a number passed", exception.getMessage());
    }
    ...
    void tooManyArgsInInvoke() {
        ...
        var exception = assertThrows(TemplateEvalException.class, () -> function.invoke(args));
        assertEquals("math:sub: too much arguments passed", exception.getMessage());
    }
    ...
    void tooFewArgsInInvoke() {
        var args = List.of();
        var exception = assertThrows(TemplateEvalException.class, () -> function.invoke(args));
        assertEquals("math:sub: 2 arguments required", exception.getMessage());
    }
