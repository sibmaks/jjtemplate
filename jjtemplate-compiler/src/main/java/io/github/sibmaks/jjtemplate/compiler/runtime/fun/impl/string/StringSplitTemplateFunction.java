...
/**
 * Template function that splits a string into a list of substrings.
 * <p>
 * The source string is split using the provided delimiter, following
 * {@link String#split(String)} semantics.
 * </p>
 *
 * <p>
 * The result is a list of strings preserving the original order.
 * </p>
 *
 * @author sibmaks
 * @since 0.4.0
